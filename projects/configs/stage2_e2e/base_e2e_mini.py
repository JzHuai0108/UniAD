...
info_root = "data/nuscenes-mini/v1.0-mini/"
file_client_args = dict(backend="disk")
ann_file_train=info_root + f"nuscenes_mini_infos_temporal_train.pkl"
ann_file_val=info_root + f"nuscenes_mini_infos_temporal_val.pkl"
ann_file_test=info_root + f"nuscenes_mini_infos_temporal_val.pkl"
